        ...
        <div class="row ">
            <div class="col-4">
                <form class="mt-3" action="punto4.php" method="post">
                    <h2>¿cuantas horas trabajaste?</h2>
                    <br>
            <div class="row">
                <div class="col-4">
                <input type="text" class="form-control" placeholder=" # de horas " name="numero1">
                </div>
            </div>
                ...
                <?php  if(isset($_POST["comprar"])): ?>
                    <h4 class="text-danger text-center">
                        <?php 
                            ...
                            if ($numero1<=40) {
                                $pago=$numero1*20000;
                                echo("trabajo ".$numero1." horas a la semana y su pago es $".$pago." pesos");
                            }
                            elseif($numero1>40){
                                $extras=$numero1-40;
                                $pago=(20000*40)+$extras*25000;
                                echo("trabajo ".$numero1." horas a la semana y su pago es $".$pago." pesos");
                            }
